...
<head>
  ...
  <title>
    MC Plásticos | Inicio para Administrador
  </title>
  ...
  <style>
   ...
   .card .card-header-primary, .card.bg-primary, .card.card-rotate.bg-primary .front, .card.card-rotate.bg-primary .back{
    background: linear-gradient(60deg, #0f3a5d, #b0bdcd);
  }
      ...
      <div class="navbar-translate">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            @guest
              {{--<li class="nav-item">
                  <a class="nav-link" href="{{ url('admin/login') }}">{{ __('Entrar') }}</a>
              </li>
              @if (Route::has('register'))
                  <li class="nav-item">
                      <a class="nav-link" href="{{ url('admin/register') }}">{{ __('Registro') }}</a>
                  </li>
                  @endif--}}
                  @else
